	...
	<div id='main'>
		<form name='frm_upload' id='frm_upload' method='post'>
			<div id='image_preview'>
				<img id='img' src="http://placehold.it/747x603">
			</div>
		...
		<form id='frm_create' name='frm_create' method='POST'>
			<div id='doc' >
				...
				<input type='text'  name='tim' placeholder='운영시간'><br/>
				<input type='text' id='place1' name='place1' value='' placeholder='경도'><br/>
				<input type='text' id='place2' name='place2' value='' placeholder='위도'><br/>
				<input type='text' name='price' placeholder='이용가격'><br/><br/>
				<input type='text' placeholder='예약??????????'><br/>
			</div>
		</form>
	</div>
	<div id='btn_zone'>
