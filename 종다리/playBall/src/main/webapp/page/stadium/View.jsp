...
<body>
	...
	<div id='main'>
		...
		<div id='find_zone'>
			...
			<div class='stadiumlist' onclick='brd.detail(${vo.serial})'>
				<div class="img">
					<img src="./img/stadiumBoard/${vo.pic }" class='stadiumimg'>			
				</div>
				<div class='list_items'>
					<span class='item_name'>${vo.name }</span><br/>
					<span class='item_price'>${vo.price }</span><br/>
					<span class='item_doc'>${vo.doc }</span><br/>
				</div>
			</div>
