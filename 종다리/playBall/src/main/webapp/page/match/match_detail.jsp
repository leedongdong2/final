...
<div id='match_detail'>
	...
	<div id='title_zone'>
		...
		<div id='sel'>
			<span class='loc'>${vo.loca }</span>
			<span class='tag'>${vo.tag }</span>
			<span class='tier'>${vo.tier }</span>
			<span class='dDate'>${vo.dDate }</span>
		</div>
	...
	<div class='SUD'>
		...
		<c:if test="${sessionScope.mid ne null }">
			<input type='button' class='sin' value='신고'/>
		</c:if>
	...
	<div class=replWrite>
		<textarea rows="5" cols="131"  id=repl_text placeholder="이상한 말은 바로 신고당함"></textarea>
