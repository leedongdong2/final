...
<div class='match_view'>
	...
	<div id='page'>
		<div class='main'>
			...
			<span class='headHit'>조회수</span>
			<span class='headVs'>상태</span>
		</div>
		...
		<div id='view'>
			...
			<input type='button' value="${vo.vs }" id = 'btnMatch' onclick="matchCancle('${sessionScope.mid }','${vo.mid }',${vo.serial},'${vo.vs }')"/>
			</c:forEach>
